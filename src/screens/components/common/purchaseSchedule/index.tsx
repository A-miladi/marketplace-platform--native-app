...
import {UpdateCompanyRequest, UpdateProfileRequest} from '@/types/user';
...
export const PurchaseSchedule = ({
  ...
  const currentDate = watch('extra_data.purchase_schedule');
  const [selectedDate, setSelectedDate] = useState(currentDate || '');

  const handleDayPress = (day: {dateString: string}) => {
    setSelectedDate(day.dateString);
    setValue('extra_data.purchase_schedule', day.dateString, {
      shouldValidate: true,
      shouldDirty: true,
    });
